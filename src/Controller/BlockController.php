        ...
        if (!is_null($block_to_edit)) {
            if ($block_to_edit->getType() != 'image') {
                ...
                if ($type_to_reload == 'title') {
                    ...
                    $title_block->setPosition($position_to_reload);
                }
                ...
                if ($type_to_reload == 'text') {
                    ...
                    $text_block->setPosition($position_to_reload);
                }
                ...
                if ($type_to_reload == 'code') {
                    ...
                    $code_block->setPosition($position_to_reload);
                }
